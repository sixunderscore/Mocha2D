...
public class SyncUtils {
    public static long createSemaphore(MemoryStack stack) {
        ...
        if (VK14.vkCreateSemaphore(Mocha2D.RENDER_CONTEXT.getLogicalDevice(), semaphoreCreateInfo, null, semaphoreBuff) != VK14.VK_SUCCESS) {
    ...
    public static long createFence(MemoryStack stack, boolean signaled) {
        ...
        if (VK14.vkCreateFence(Mocha2D.RENDER_CONTEXT.getLogicalDevice(), fenceCreateInfo, null, fenceBuff) != VK14.VK_SUCCESS) {
